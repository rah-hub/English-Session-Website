...
function App() {
  ...
  useEffect(() => {
    // Respect explicit user choice if present; otherwise follow system preference
    ...
    // Listen for system theme changes and update only when user has not chosen a theme
